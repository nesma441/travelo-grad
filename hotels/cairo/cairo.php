<!DOCTYPE html>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.min.js"
     ...
     <link rel="stylesheet" href="css/Pharaonic.css" />
...
<section class="important-trip">
          <div class="box">
            <img src="images/bay 1.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>BAYT ZAINA - Nubian hospitality house</span>
            </div>
            <button class="btn-click" onclick="document.location.href='hotel1/BAYT ZAINA - Nubian Hospitality House.html'">More</button>
          </div>
          <div class="box">
            <img src="images/the 3.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Double Room with Sea View</span>
            </div>
            <button class="btn-click" onclick="document.location.href='hotel2/Double Room with Sea View.html'">More</button>
          </div>
  </section>
