    ...
    <div class="embed-responsive embed-responsive-21by9">
      ...
      <section class="important-trip">
        ...
        <div class="box">
          ...
          <button class="btn-click" onclick="document.location.href='Alexandria/Alexandria.php'">More</button>
        </div>
        <div class="box">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-4 col-md-pull-7">
                ...
                <form action="hot.php" method="post">
                  <div class="form-group" >
                    <span class="form-label">Your Destination</span>
                    <input class="form-control" type="text" name="locHot" placeholder="Enter a destination ">
                  </div>
                  <div class="form-group" >
                    <span class="form-label">Your hotel</span>
                    <input class="form-control" type="text" name="hotelH" placeholder="Enter a destination ">
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
