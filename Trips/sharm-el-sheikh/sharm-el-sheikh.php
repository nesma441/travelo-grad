...
<section class="important-trip">
          <div class="box">
            <img src="images/char1.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Charmillion Club Resort</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip1/Charmillion Club Resort.html'">More</button>
          </div>
          <div class="box">
            <img src="images/cle1.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Cleopatra Luxury Resort</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip2/Cleopatra Luxury Resort.html'">More</button>
          </div>
  </section>
