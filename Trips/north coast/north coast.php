...
<section class="important-trip">
          <div class="box">
            <img src="images/por7.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Porto Marina Resort</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip1/Porto Marina Resort.html'">More</button>
          </div>
          <div class="box">
            <img src="images/tol5.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Tolip North Coast Hotel</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip2/Tolip North Coast Hotel.html'">More</button>
          </div>
  </section>
