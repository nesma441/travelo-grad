...
<section class="important-trip">
          <div class="box">
            <img src="images/hil7.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Hilton Luxor Resort & Spa</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip1/Hilton Luxor Resort & Spa.html'">More</button>
          </div>
          <div class="box">
            <img src="images/son2.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Sonesta St. George Luxor</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip2/Sonesta St. George Luxor.html'">More</button>
          </div>
  </section>
