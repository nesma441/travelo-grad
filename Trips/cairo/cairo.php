<!DOCTYPE html>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.min.js"
     ...
     <link rel="stylesheet" href="css/Pharaonic Village.css" />
    ...
    <nav class="navbar">
        ...
        <div>
            <ul class="nav justify-content-end">
                <li class="nav-item">
                    <a class="nav-link active" onclick="document.location.href='../../travelo.html'">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" onclick="document.location.href='../Trips.html'">Trips</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " onclick="document.location.href='../../Day Use/Day Use.html'">Day use</a>
                </li>
                <li class="nav-item">
                ...
                <div class="my_account">
                    <li class="nav-item">
                        <a class="nav-link "><i class="far fa-user mr-3"></i>name</a>
                    </li>
                </div>
            </ul>
        </div>
            ...
            <div class="d-flex justify-content-between h-100">
                <div class="reservations_header col-6">
                    <div>
                        ...
                        <p>
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. In quis hic quisquam molestias accusamus reiciendis exercitationem, deserunt quae quibusdam voluptas
                        </p>
                    </div>
                </div>
...
<section class="important-trip">
          <div class="box">
            <img src="images/pyr7.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>
              Ramses Hilton Hotel & Casino</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip1/Ramses Hilton Hotel & Casino.html'">More</button>
          </div>
          <div class="box">
            <img src="images/ram7.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Pyramisa Suites Hotel Cairo</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip2/Pyramisa Suites Hotel Cairo.html'">More</button>
          </div>
  </section>
