...
<section class="important-trip">
          <div class="box">
            <img src="images/mov5.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Citymax hotel Aswan</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip1/Citymax hotel Aswan.html'">More</button>
          </div>
          <div class="box">
            <img src="images/mov9.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Movenpick Resort Aswan</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip2/Movenpick Resort Aswan.html'">More</button>
          </div>
  </section>
