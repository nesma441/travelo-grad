...
<section class="important-trip">
          <div class="box">
            <img src="images/eco2.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Ecotel Dahab Bay View Resort</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip1/Ecotel Dahab Bay View Resort.html'">More</button>
          </div>
          <div class="box">
            <img src="images/tro5.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Tropitel Dahab Oasis</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip2/Tropitel Dahab Oasis.html'">More</button>
          </div>
  </section>
