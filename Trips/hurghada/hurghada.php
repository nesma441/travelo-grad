...
<section class="important-trip">
          <div class="box">
            <img src="images/amc5.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>AMC Royal Resort</span>
            </div>
            <button class="btn-click" onclick="document.location.href='trip1/AMC Royal Resort.html'">More</button>
          </div>
          <div class="box">
            <img src="images/kem6.jpg" alt="images" width="100%" height="300px">
            <div class="trip-span">
              <span>Kempinski Hotel Soma Bay</span>
            </div>
            <button class="btn-click"onclick="document.location.href='trip2/Kempinski Hotel Soma Bay.html'">More</button>
          </div>
  </section>
